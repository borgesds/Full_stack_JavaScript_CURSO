class app {
    ...
    enrollSpaceship() {
        ...
        if(spaceshipKind == "1") {
            ...
            let sitsQuantity = prompt("Quantos lugares a nave tem?")
    ...
    showInitialMenu() {
        const promptMessage = "O que você quer fazer?\n" + 
                              "1- Acelerar a nave\n" + 
                              "2- Trocar de nave\n" +
                              "3- Imprimir e Sair"
    ...
    accelerationSpaceship() {
        let accelerationSpaceship = Number(prompt("Quanto quer acelerar?"))
        this.spaceship.speedUp(accelerationSpaceship)
    }
